namespace Ewan.Finance.Core
{
    public struct Consts
    {
        public const int NameLength = 128;
        public const int ActionsLength = 250;
        public const int AssignedNameLength = 300;
        public const string DescriptionColumnType = "nvarchar(max)";
