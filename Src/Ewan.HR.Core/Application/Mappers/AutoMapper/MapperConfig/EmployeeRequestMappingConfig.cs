...
{
    public class EmployeeRequestMappingConfig : IMappingAction<EmployeeData, EmployeeRequestVM>
    {
        ...
        public void Process(EmployeeData source, EmployeeRequestVM destination, ResolutionContext context)
        {
