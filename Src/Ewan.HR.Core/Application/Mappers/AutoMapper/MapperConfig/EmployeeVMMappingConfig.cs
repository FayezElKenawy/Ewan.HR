...
{
    public class EmployeeVMMappingConfig : IMappingAction<Employee, EmployeeVM>
    {
        ...
        public void Process(Employee source, EmployeeVM destination, ResolutionContext context)
        {
